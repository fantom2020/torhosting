...
Part 1
find ./ -type f -readable -writable -exec sed -i "s/hosting.CHANGE-THIS-TO-YOUR-OWN-DOMAIN.com/CHANGE-THIS-TO-YOUR-OWN-ADDRESS/g" {} \;

Part 2 do not run this yet wait till after reboot
find ./ -type f -readable -writable -exec sed -i "s/CHANGE-THIS-TO-YOUR-OWN-ONION.onion/CHANGE-THIS-TO-YOUR-OWN-ONION/g" {} \;
