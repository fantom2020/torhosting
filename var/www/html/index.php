...
echo "</footer>\n";
echo "</div>\n";
echo "<span class=\"w3-bottom w3-bar w3-tag w3-dark-grey\" style=\"cursor:url(/bugs.png),url(/myBall.cur),auto;\"><strong style=\"color:#cccccc\">CHANGE-THIS-TO-YOUR-OWN-ONION.onion</strong></span>\n";
echo "</body>\n";
echo "</html>";
